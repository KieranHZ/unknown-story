Locales['fr'] = {
  ...
  ['ambulance_stock'] = 'Inventaire Feuille d\'Or',
  ['quantity'] = 'Quantité',
  ...
  ['actions_prompt'] = 'Appuyez sur ~INPUT_CONTEXT~ access the ~y~Ambulance Actions~s~.',
  ...
  -- Death
  ['respawn_available_in'] = '~r~%s : %s~s~',
  ['respawn_bleedout_in'] = '~w~Maintenir [E] pour etre reannimer plus vite',
