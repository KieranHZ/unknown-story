...
function OpenExitGouv()
    SetEntityCoords(PlayerPedId(), Config.Zones.OfficeOutside.Pos.x, Config.Zones.OfficeOutside.Pos.y, Config.Zones.OfficeOutside.Pos.z)
end
...
function OpenTpGouv()
    SetEntityCoords(PlayerPedId(), Config.Zones.OfficeInside.Pos.x, Config.Zones.OfficeInside.Pos.y, Config.Zones.OfficeInside.Pos.z)
end
