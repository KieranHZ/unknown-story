Locales['fr'] = {
  ...
  ['imp_flatbed']               = '~r~Impossible! ~s~Vous devez avoir un ~b~Flatbed ~s~pour éffectuer cette action',
  ['objects']                   = 'Intéraction objets',
  ['roadcone']                  = 'Placer un Plot orange',
  ['toolbox']                   = 'Placer une Boîte à outils',
  ['mechanic_stock']            = 'Inventaire mécano',
  ['quantity']                  = 'Quantité',
  ...
  ['player_cannot_hold']        = 'Vous n\'avez plus de place dans votre inventaire',
}
