...
Config.TimeToDistil           = 5000 --Temps pour distiller
Config.ItemDistiled           = 20    --Nombre de pétrole pour faire 10 d'essence

Config.TimeToRecolte          = 3000 --Temps pour recolté
Config.ItemRecolte            = 20     --nombre de petrole par timer
...
Config.Zones = {
	...
	vente = {
		Pos   = {x = 1717.00, y = -1480.00, z = 113.00},
		Size  = {x = 10.0, y = 10.0, z = 0.4},
		Color = {r = 255, g = 0, b = 0},
		Type  = 1
	},
