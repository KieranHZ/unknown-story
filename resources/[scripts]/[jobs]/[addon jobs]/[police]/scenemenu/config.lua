...
Config.Objects = {
    { Displayname = "Barriere de police", Object = "prop_barrier_work05" },
    { Displayname = "Grand Cone", Object = "prop_roadcone01a" },
    { Displayname = "Petit Cone", Object = "prop_roadcone02b" },
    { Displayname = "Gazebo", Object = "prop_gazebo_02" },
    { Displayname = "Signalisation Interdit", Object = "prop_sign_road_restriction_10" },
    { Displayname = "Barriere en beton", Object = "prop_barier_conc_05c"},
    { Displayname = "Signalisation 1", Object = "prop_consign_02a"},
    { Displayname = "Signalisation 2", Object = "prop_consign_01b"},
    { Displayname = "army 1", Object = "prop_mb_hesco_06"},
    { Displayname = "army 2", Object = "prop_mb_sandblock_01"},
    { Displayname = "Army 3", Object = "prop_mb_sandblock_02"},
    { Displayname = "Army 4", Object = "prop_mb_sandblock_03"},
    { Displayname = "army 5", Object = "prop_mb_sandblock_04"},
    { Displayname = "army 6", Object = "prop_mb_sandblock_05"},
    { Displayname = "Army 7", Object = "prop_mc_conc_barrier_01"},
    { Displayname = "barriere fléche", Object = "prop_mp_arrow_barrier_01"},
    ---------------------------------------------------------------
    ---------------------- Add more below! ------------------------
    -----------------------v-------------v-------------------------
