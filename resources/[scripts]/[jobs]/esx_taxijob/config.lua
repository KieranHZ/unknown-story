...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'taxi', label = 'Taxi', price = 25000 }
	},
	uber = {},
	boss = {}
}
...
Config.Zones = {
	...
	CarGarage = {
		...
		SpawnPoints = {
			{ coords = vector3(917.12, -167.29, 74.5), heading = 102.0, radius = 4.0 },
			{ coords = vector3(915.46, -170.83, 74.5), heading = 99.6, radius = 4.0 },
			{ coords = vector3(919.65, -163.82, 74.5), heading = 98.0, radius = 4.0 },
			{ coords = vector3(911.71, -164.6, 74.5), heading = 197.44, radius = 4.0 },
			{ coords = vector3(919.65, -163.82, 74.5), heading = 98.0, radius = 4.0 },
			{ coords = vector3(919.65, -163.82, 74.5), heading = 98.0, radius = 4.0 },
		},
