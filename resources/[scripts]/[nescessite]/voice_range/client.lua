local VoiceMode = {
	{ dist = 3, message = "Niveau de voix faible (3 mètres)" },
	{ dist = 8, message = "Niveau de voix faible (8 mètres)" },
	{ dist = 14, message = "Niveau de voix faible (14 mètres)" },
	{ veh = true, dist = 4, func = function(ped) return IsPedInAnyVehicle(ped) end, message = "Niveau de voix spécifique (véhicule)" },
}
