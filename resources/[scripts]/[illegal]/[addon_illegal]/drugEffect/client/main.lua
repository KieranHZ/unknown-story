...
--[[--Weed
RegisterNetEvent('drugEffects:onWeed')
AddEventHandler('drugEffects:onWeed', function()
...
--Extasie
RegisterNetEvent('drugEffects:onExtasie')
AddEventHandler('drugEffects:onExtasie', function()
...
--Meth
RegisterNetEvent('drugEffects:onMeth')
AddEventHandler('drugEffects:onMeth', function()
...
--lsd
RegisterNetEvent('drugEffects:onlsd')
AddEventHandler('drugEffects:onlsd', function()
