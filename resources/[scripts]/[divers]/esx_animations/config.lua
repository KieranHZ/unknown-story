...
--		    {label = "Fumer un joint", type = "scenario", data = {anim = "WORLD_HUMAN_SMOKING_POT"}},
			...
			{label = "Sortir la caméra", type = "anim", data = {lib = "ac_ig_3_p3_b-0 exportcamera-0", anim = "exportcamera"}},
			{label = 'parapluie', data = {type = 'anim', ad = "amb@world_human_drinking@coffee@male@base", anim = "base", prop = 'p_amb_brolly_01', proptwo = 0, boneone = 57005, bonetwo = nil, body = 49, x = 0.15, y = 0.005, z = -0.02, xa = 80.0, yb = -20.0, zc = 175.0}},
		}
	},
