...
Config = {}
Config.Locale = 'en'
Config.MaxOwnedCarsInGarage = 30 -- Maxixum number of cars that a player can store
...
Config.CarPoundPrice      = 100 -- Car Pound Price.
Config.BoatPoundPrice     = 300 -- Boat Pound Price.
Config.AircraftPoundPrice = 750 -- Aircraft Pound Price.
Config.JobPoundPrice  = 100 -- Job Pound Price.
Config.PolicingPoundPrice  = 100 -- Policing Pound Price.
...
Config.CarPounds = {
	...
	Pound_Sandy = {
		PoundPoint = { x = 1651.38, y = 3804.84, z = 38.65 },
		SpawnPoint = { x = 1627.84, y = 3788.45, z = 33.77, h = 308.53 }
	},
	Pound_Paleto = {
...
Config.PrivateCarGarages = {
	...
	Garage_HillcrestAvenue2862 = {
		...
		GaragePoint = { x = -688.71, y = 597.57, z = 141.64 },
