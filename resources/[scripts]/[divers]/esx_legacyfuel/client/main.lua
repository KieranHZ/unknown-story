		...
		if not InBlacklistedVehicle then
			...
			if nearPump and IsCloseToLastVehicle then
				...
				elseif IsFueling then
					...
					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "Appuyer sur ~g~G ~w~annuler le ravitaillement de votre véhicule. $~r~" .. price .. "")
...
local gas_stations = {
	...
	{ ['x'] = -69.25, ['y'] = -2529.71, ['z'] = 8.13},
	{ ['x'] = -63.15, ['y'] = -2534.06, ['z'] = 8.13}
}
