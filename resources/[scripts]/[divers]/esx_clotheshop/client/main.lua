...
function OpenShopMenu()
    ...
    local elements = {
        { label = 'Vestiaire | Mettre une tenue', value = 'player_dressing' },
        { label = 'Vestiaire | Supprimer une tenue', value = 'remove_cloth' },
        { label = 'Boutique de vêtements', value = 'buyshop' }
    }
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vestiaire',
            {
                ...
                if data.current.value == 'player_dressing' then
                    ESX.TriggerServerCallback('esx_property:getPlayerDressing', function(dressing)
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing',
                                {
                                    title = 'Vestiaire | Mettre une tenue',
                                    align = 'top-left',
                                    elements = elements
                ...
                elseif data.current.value == 'remove_cloth' then
                    ...
                    ESX.TriggerServerCallback('esx_property:getPlayerDressing', function(dressing)
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'remove_cloth', {
                            title = 'Vestiaire | Supprimer une tenue',
                            align = 'top-left',
                            elements = elements
                        }, function(data2, menu2)
                            menu2.close()
                ...
                elseif data.current.value == 'buyshop' then
                    HasPayed = false
