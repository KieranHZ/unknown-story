...
RegisterNetEvent('esx_truck_inventory:setJobVehicule')
AddEventHandler('esx_truck_inventory:setJobVehicule', function(vehicle)
    vehicleJobPlate = vehicle
end)
                            ...
                            'default', GetCurrentResourceName(), 'inventory_player',
                            {
                                ...
                                ESX.UI.Menu.Open(
                                        ...
                                        function(data4, menu4)
                                            ...
                                            while vehiclePlate == '' and vehicleJobPlate == '' do
                                                Citizen.Wait(1000)
                                            end
                                            if vehiclePlate ~= '' then
                                                ...
                                                for i = 1, #vehicleJobPlate do
                                                    if vehicleJobPlate[i].plate == GetVehicleNumberPlateText(vehFront) then
                                                        ownedV = 1
                                                        break
                                                    else
                                                        ownedV = 0
