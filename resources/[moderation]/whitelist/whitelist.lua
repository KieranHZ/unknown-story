...
if data then
    ...
    print("Loaded " .. #whitelistArray .. " identifiants sur la whitelist")
end
...
AddEventHandler("playerConnecting", function(playerName, setKickReason, deferrals)
    ...
    deferrals.update("Veuillez patienter, on vérifier la whitelist")
    ...
    for myIdx,identifier in pairs(GetPlayerIdentifiers(s)) do
        ...
        for wIdx,i in ipairs(whitelistArray) do
			...
			deferrals.update(string.format("Vérification de la whitelist: %.2f%%", (currentId / totalChecksNeeded)*100))
	...
	deferrals.done("Ce serveur est inscrit sur une whitelist")
end)
