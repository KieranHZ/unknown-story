...
Citizen.CreateThread(function()
	...
	AddEventHandler('EasyAdmin:amiadmin', function()
		...
		if DoesPlayerHavePermission(source,"easyadmin.ban") then
			TriggerClientEvent('chat:addSuggestion', source, '/kick', GetLocalisedText("chatsuggestionban"), { {name='id', help="l'id du joueur"}, {name='raison', help="raison du bannissement"} } )
		end
		if DoesPlayerHavePermission(source,"easyadmin.kick") then
			TriggerClientEvent('chat:addSuggestion', source, '/exp', GetLocalisedText("chatsuggestionkick"), { {name='id', help="l'id du joueur"}, {name='raison', help="raison de l'expulsion"}} )
		end
		if DoesPlayerHavePermission(source,"easyadmin.spectate") then
			TriggerClientEvent('chat:addSuggestion', source, '/spec', GetLocalisedText("chatsuggestionspectate"), { {name='id', help="l'id du joueur"} })
		end
